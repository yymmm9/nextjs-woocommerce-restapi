  ...
  return (
    ...
    ">
      ...
      bg-white border border-zinc-700 w-fit p-2 rounded">
        ...
        <Link href=""><a className="flex items-center p-1 px-2 mx-1">Orders</a></Link>
        <Link href=""><a className="flex items-center p-1 px-2 mx-1">Customers</a></Link>
        <Link href=""><a className="flex items-center p-1 px-2 mx-1">KOTs</a></Link>
      </div>
    </nav>
)};
